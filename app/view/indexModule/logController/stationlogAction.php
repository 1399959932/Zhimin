...
<script type="text/javascript" src="/js/datamgr_stationlog.js">
</script>	
...
<div class="condition_s sub">													
	<input type="submit" name="table_flag" value="" />					
</div>					
<div class="clear">
</div>				
</div>			
			...
			<th class="t_back" width="16%">工作站名
			</th>							
			<th width="11%">操作类型
			</th>							
			<th class="t_back" width="14%">操作时间
			</th>							
			<th width="20%">记录仪编号
			</th>															
			<!-- 
