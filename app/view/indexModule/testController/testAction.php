...
foreach ($medias as $media ) {
	...
	echo '" style="cursor:pointer">查看</a>' . "\r\n" . '										<a class="a_down" href="';
	echo Zhimin::buildUrl('', '', '', 'action=media_down&id=' . $media['id']);
	echo '" target="_blank" style="cursor:pointer">下载</a>' . "\r\n" . '									</span>' . "\r\n" . '								</td>' . "\r\n" . '								<td>';
	echo $media['hostname'] . ' ( ' . $media['hostcode'] . ' )';
	echo '</td>' . "\r\n" . '								<td>';
	echo $media['dname'];
	echo '</td>' . "\r\n" . '								<td>';
	echo $media['hostbody'];
